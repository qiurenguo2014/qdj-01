...
extern PointXY point_base;//当前窗体位置
extern PointXY Current_Coor;//当前坐标
extern void GUI_Enter_ApiMode (void);
extern void GUI_Exit_ApiMode (void);
extern uint8_t GUI_Set_X0_Y0_Base (const PointXY *p);
extern void GUI_Get_X0_Y0_Base (const PointXY *p);
extern uint16_t GUI_Get_Offset_X0 (void);
extern uint16_t GUI_Get_Offset_Y0 (void);
extern void GUI_Point (int16_t x, int16_t y, TCOLOR color);
extern void GUI_RLine (int16_t x0, int16_t y0, int16_t y1, TCOLOR color);
extern void GUI_HLine (int16_t x0, int16_t y0, int16_t x1, TCOLOR color);
/****************************************************************************
* 名称：GUI_Rectangle()
* 功能：画矩形。
* 入口参数： x0		矩形左上角的x坐标值
